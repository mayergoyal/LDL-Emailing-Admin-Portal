...
app.post("/sendemail1", (req, res) => {
 ...
 if (!name || !email) {
  ...
  <p style="font-size: 16px; color: #333; margin-bottom: 20px;">
    ...
    New year represents new beginnings and new moves. On behalf of <strong>LDL JIIT</strong>, we're all set to begin <strong>2025</strong> with new hopes and aims with that same notion of "change" for which we all are working and giving our best to lift those whose feet are now the responsibility of our backs.
    <br /><br />
